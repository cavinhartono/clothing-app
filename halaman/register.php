...
<body class="bg-gray-200 flex justify-center items-center min-h-screen">
  <form action="../algoritma/auth/Register.php" method="POST" class="w-[400px] py-12 px-8 rounded-md bg-white shadow-sm">
    ...
    <div class="relative w-full my-6">
      <input type="text" id="name" name="name" class="peer w-full px-3 py-2 border placeholder:text-transparent" placeholder="Name" required>
    ...
    <div class="relative w-full my-6">
      <input id="password" type="password" name="password" class="peer w-full px-3 py-2 border placeholder:text-transparent" placeholder="Password" required>
    ...
    <div class="relative w-full my-6">
      <input type="text" name="address" id="address" class="peer w-full px-3 py-2 border placeholder:text-transparent" placeholder="Address" required />
